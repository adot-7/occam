...
class CaseResult(BaseModel):
    ...
    passed: bool
    grade_error: str | None      # checker exception or structured checker failure
...
| `execution.case` | `generation`, `variant`, `case_id`, `passed`, `cost_usd`, `latency_s`, `answer_prefix` (≤120 chars), `grade_error`, `role_error` |
